...
function countOrders()
{
    global $query;
    $userId = $_SESSION['id'];
    $result = $query->executeQuery("SELECT COUNT(*) AS total_orders FROM orders WHERE user_id = $userId");
    $row = $result->fetch_assoc();
...
<div class="humberger__menu__wrapper">
    ...
    <div class="humberger__menu__cart">
        <ul>
            ...
            <li><a href="./my-orders.php"><i class="fa fa-list-alt"></i> <span><?= countOrders(); ?></span></a></li>
        </ul>
        ...
        <ul>
            ...
            <li>
                <a href="./my-orders.php"
                    class="<?= ($currentPage == 'my-orders.php') ? 'active' : ''; ?>">My Orders</a>
            </li>
        </ul>
    </nav>
            ...
            <div class="col-lg-3">
                <div class="header__cart">
                    <ul>
                        ...
                        <li><a href="./shoping-cart.php"><i class="fa fa-shopping-bag"></i>
                                <span><?= countTable('cart'); ?></span></a></li>
                        <li><a href="./my-orders.php"><i class="fa fa-list-alt"></i>
                                <span><?= countOrders(); ?></span></a></li>
                    </ul>
