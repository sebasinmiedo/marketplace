...
-- Create orders table to track purchase information
CREATE TABLE orders (
    id INT(11) NOT NULL AUTO_INCREMENT,
...
('Televizor JVC 32N3105 HD Smart', 4, 2, 270, 140, 'Ultraingichka ramkali konstruksiya standart tv nisbatidan ahamiyatli ustun keluvchi ekran va korpusning olchamlarini yuqori nisbatini taminlaydi.Jozibali metall ramka va yaxlit konstruksiya sharofati bilan Xiaomi TV A2 har qanday interyerda yorqin detal bolib qoladi.Maksimal darajadagi ixcham olchamlar bilan, Mi TV A2 32" televizori har qanday fazoga juda yaxshi mos keladi.Maqbul 50 dyuymlar sizga harakatlarga shongib ketishga va shu vaqtning ozida tasvir olchami va sifati ortasidagi muvozanatni saqlab qolish imkonini beradi.', 5.0, 56),
